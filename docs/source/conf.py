...
# demo_kedro_pythonic_catalog documentation build
...
from demo_kedro_pythonic_catalog import __version__ as release

# -- Project information -----------------------------------------------------

project = "demo_kedro_pythonic_catalog"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "demo_kedro_pythonic_catalogdoc"
...
latex_documents = [
    (
        master_doc,
        "demo_kedro_pythonic_catalog.tex",
        "demo_kedro_pythonic_catalog Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "demo_kedro_pythonic_catalog",
        "Project demo_kedro_pythonic_catalog codebase.",
        "Data-Science",
    )
]
